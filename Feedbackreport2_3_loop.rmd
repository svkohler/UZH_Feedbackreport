...
b <- ggplot() + theme_gray() +
  ...
  scale_color_identity(name = NULL,
                          ...
                          guide = "legend") +
  labs(subtitle="Risk Vs Return", caption = "Annualized Volatility and Return during the investment period \nBlaBlaBla")
...
c <- ggplot(data=inv.style, aes(coeffs,factor))+geom_point(aes(col=y)) +
  ...
  labs(subtitle="Investment Style", caption = "Correlation of your investment style with different \ncharacteristic portfolios. \nThe black line references a correaltion of 1.")
